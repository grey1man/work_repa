...
$(document).ready(function() {
	...
	Janus.init({debug: "all", callback: function() {
			...
			janus = new Janus(
				{
					server: "http://192.168.123.20:8088/janus",   //enter your janus gateway IP address
					success: function() {
...
function startStream() {
	...
	// No remote video yet
	//$('#stream').append('<video class="rounded centered" id="remotevideo" width="100%" height="100%" />');
	Janus.attachMediaStream($('#stream').get(0), stream);
	$("#stream").get(0).play();
}
